...
('Шампунь LOreal для сухого волоса', 'Шампунь LOreal Professional для сухого и поврежденного волоса. Увлажняет и питает волосы.', 10, 'Шампуни и бальзамы', 500.00, TRUE, FALSE, NOW(), NOW()),
('Бальзам LOreal для сухого волоса', 'Бальзам LOreal Professional для сухого и поврежденного волоса. Увлажняет и питает волосы.', 10, 'Шампуни и бальзамы', 600.00, TRUE, FALSE, NOW(), NOW()),
('Краска LOreal Majirel для волос', 'Постоянная краска для волос LOreal Majirel. Богатый цвет и глубокое питание волос.', 5, 'Краски для волос', 1500.00, TRUE, FALSE, NOW(), NOW()),
